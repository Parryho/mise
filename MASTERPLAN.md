...
## 6b. Offene Findings — Sicherheit, Performance, Schema (aus DECISIONS.md)
...
| Issue | Datei | Status |
|-------|-------|--------|
| `date` als TEXT statt DATE-Typ | `shared/schema.ts` | offen |
...
11.02.2026: Phase 13.20 (Pexels→gutekueche.at: 0 Pexels remaining)
```
